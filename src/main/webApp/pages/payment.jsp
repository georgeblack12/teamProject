...
<%--<html>--%>
<%--<head>--%>
<%--&lt;%&ndash;    Had to make edits to links for images and css in order to get the whole website working together.--%>
<%-- Thanks, George Black.&ndash;%&gt;--%>
<%--    <meta charset="utf-8">--%>
<%--    <link href="../css/payment_style.css" type="text/css" rel="stylesheet">--%>


<%--&lt;%&ndash;    Files needed to be added in order to get Sweet alert 2. These are used in the pop ups when the person wishes--%>
<%--to make-a payment. Thanks, George Black&ndash;%&gt;--%>
...
<%--&lt;%&ndash;Table probably needs to be edited to meet the requirements of horsePay, we do not need a name on Car,&ndash;%&gt;--%>
<%--&lt;%&ndash;Card Number, or timeZone (we can assume that it is GMT). Thank, George Black&ndash;%&gt;--%>
<%--<table id="table">--%>
<%--    <tr>--%>
<%--        <td class="tip">Payment type:</td>--%>
<%--        <td>--%>
<%--            <select class="border">--%>
<%--&lt;%&ndash;                Only need the option of payment to be HorsePay&ndash;%&gt;--%>
<%--                <option>HorsePay (not HorsePlay, ya ding)</option>--%>
<%--                &lt;%&ndash;				<option>VISA</option>&ndash;%&gt;--%>
<%--                &lt;%&ndash;				<option>MASTER</option>&ndash;%&gt;--%>
<%--            </select>--%>
<%--        </td>--%>
<%--    </tr>--%>

<%--&lt;%&ndash;    Horsepay does not require that we get name on card, card number or time zone. This needs to be changed--%>
<%--Thanks, George Black&ndash;%&gt;--%>
<%--    <tr>--%>
...
<%--&lt;%&ndash;	<div id="pay">Pay now  £<span id="money"></span></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;Edited to display total cost. Additionally, now calls the askToCompeteOrder function. Thanks, George Black&ndash;%&gt;--%>
