...
public class LoginController {
     ...
     * Additionally, if they can login (as a customer), the corresponding customer value is set as a session
     ...
     * @return A ModelAndView that will change the client's page. If the login was successful, and the user is a customer,
     * they are sent to the shopping page. If the login was successful, and the user is an admin, they are sent to the analytics
     * page. If the login is not successful, they return to the same page, and an error is displayed.
     */
